...
/**
 * Implementation of the use case to soft-delete a special selection by deactivating it and writing
 * a delete entry in the change history.
 */
public class DeleteSpecialSelectionService implements DeleteSpecialSelectionUseCase {
  ...
  /**
   * Creates a new delete special selection service.
   *
   ...
   */
  public DeleteSpecialSelectionService(
  ...
  @Override
  public SpecialSelectionConfiguration execute(Long productId, String changedBy) {
