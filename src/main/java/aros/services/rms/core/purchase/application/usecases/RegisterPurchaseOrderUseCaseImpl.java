 ...
 * </ol>
 */
public class RegisterPurchaseOrderUseCaseImpl implements RegisterPurchaseOrderUseCase {
  ...
  private final InventoryMovementUseCaseImpl inventoryMovementHelper;
  private final Logger logger;

  public RegisterPurchaseOrderUseCaseImpl(
      ...
      InventoryMovementUseCaseImpl inventoryMovementHelper,
      Logger logger) {
