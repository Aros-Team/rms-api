 ...
 */
public class CreateSupplierUseCaseImpl
    implements CreateSupplierUseCase, UpdateSupplierUseCase, GetSuppliersUseCase {

  private static final org.slf4j.Logger log =
      LoggerFactory.getLogger(CreateSupplierUseCaseImpl.class);

  private final SupplierRepositoryPort supplierRepositoryPort;
  private final Logger logger;

  public CreateSupplierUseCaseImpl(SupplierRepositoryPort supplierRepositoryPort, Logger logger) {
