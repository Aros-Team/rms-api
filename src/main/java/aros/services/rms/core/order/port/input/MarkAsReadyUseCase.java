...
/**
 * Caso de uso para marcar una orden como lista para entregar.
 * Permite al cocinero indicar que terminó la preparación.
 */
public interface MarkAsReadyUseCase {

    /**
     * Marca una orden específica como READY.
     * Solo puede usarse en órdenes en estado PREPARING.
     *
