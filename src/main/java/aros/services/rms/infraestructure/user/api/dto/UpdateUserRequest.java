...
public record UpdateUserRequest(
    ...
    @NotBlank(message = "Campo requerido") @Pattern(message = "El nombre solo permite letras y espacios", regexp = "^[a-zA-ZáéíóúÁÉÍÓÚñÑ\\s]+$") @Size(max = 100, message = "El nombre debe tener máximo 100 caracteres") String name,
