...
/** DTO representing an option group within a special selection configuration. */
@Schema(description = "Option group within a special selection")
public record SpecialSelectionGroupDto(
    @Schema(description = "Group ID (null for new groups)", example = "1") Long id,
    @Schema(description = "Group name", example = "Proteína") @NotBlank String name,
    ...
    @Schema(description = "Available product option IDs") List<Long> optionIds) {}
